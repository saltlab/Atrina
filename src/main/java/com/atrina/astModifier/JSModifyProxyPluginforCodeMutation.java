...
import com.atrina.executionTracer.DOM_JS_ExecutionTracer;
import com.atrina.executionTracer.JSExecutionTracer;
...
public class JSModifyProxyPluginforCodeMutation extends mutandis.astModifier.JSModifyProxyPlugin {
	...
	private com.atrina.astModifier.JSASTModifier modifierToGetMutatedVerInfo;
	public JSModifyProxyPluginforCodeMutation(JSASTModifier modify, JSCyclCompxCalc cyclCompxCalc, com.atrina.astModifier.JSASTModifier modifierToGetMutatedVerInfo) {
	...
	public JSModifyProxyPluginforCodeMutation(JSASTModifier modify, List<String> excludes,JSCyclCompxCalc cyclCompxCalc,  com.atrina.astModifier.JSASTModifier modifierToGetMutatedVerInfo) {
		super(modify,excludes,cyclCompxCalc);
		this.modifierToGetMutatedVerInfo=modifierToGetMutatedVerInfo;
	}
	
	public JSModifyProxyPluginforCodeMutation(String outputfolder,  com.atrina.astModifier.JSASTModifier modifierToGetMutatedVerInfo){
		super(outputfolder);
		this.modifierToGetMutatedVerInfo=modifierToGetMutatedVerInfo;
